...
public final class eg {
    ...
    public static final class a implements Serializable, GenericArrayType {
        ...
        public boolean equals(Object obj) {
            return (obj instanceof GenericArrayType) && eg.k(this, (GenericArrayType) obj);
        }
        ...
        public String toString() {
            return eg.s(this.a) + HttpUrl.PATH_SEGMENT_ENCODE_SET_URI;
        }
    }
    ...
    public static final class b implements Serializable, ParameterizedType {
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            if (type2 instanceof Class) {
                ...
                boolean z = true;
                dg.b(type != null || cls.getEnclosingClass() == null);
                if (type != null && cls.getEnclosingClass() == null) {
                    z = false;
                }
                dg.b(z);
            }
            this.a = type == null ? null : eg.p(type);
            this.b = eg.p(type2);
            ...
            while (true) {
                ...
                typeArr3[i] = eg.p(typeArr3[i]);
                i++;
            }
        }

        public boolean equals(Object obj) {
            return (obj instanceof ParameterizedType) && eg.k(this, (ParameterizedType) obj);
        }
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.d) ^ this.b.hashCode()) ^ eg.l(this.a);
        }

        public String toString() {
            StringBuilder sb = new StringBuilder((this.d.length + 1) * 30);
            sb.append(eg.s(this.b));
            if (this.d.length == 0) {
                return sb.toString();
            }
            sb.append("<");
            sb.append(eg.s(this.d[0]));
            for (int i = 1; i < this.d.length; i++) {
                sb.append(", ");
                sb.append(eg.s(this.d[i]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static final class c implements Serializable, WildcardType {
        ...
        public c(Type[] typeArr, Type[] typeArr2) {
            dg.b(typeArr2.length <= 1);
            dg.b(typeArr.length == 1);
            if (typeArr2.length != 1) {
                dg.a(typeArr[0]);
                eg.v(typeArr[0]);
                this.b = null;
                this.a = eg.p(typeArr[0]);
                return;
            }
            dg.a(typeArr2[0]);
            eg.v(typeArr2[0]);
            dg.b(typeArr[0] == Object.class);
            this.b = eg.p(typeArr2[0]);
            this.a = Object.class;
        }

        public boolean equals(Object obj) {
            return (obj instanceof WildcardType) && eg.k(this, (WildcardType) obj);
        }

        @Override // java.lang.reflect.WildcardType
        public Type[] getLowerBounds() {
            Type type = this.b;
            return type != null ? new Type[]{type} : eg.a;
        }
    ...
    */
    public static java.lang.reflect.Type h(java.lang.reflect.Type r8, java.lang.Class<?> r9, java.lang.reflect.Type r10) {
        ...
        Lb4:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eg.h(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type):java.lang.reflect.Type");
    }
    ...
    public static Type m(Type type, Class<?> cls, Class<?> cls2) {
        dg.b(cls2.isAssignableFrom(cls));
    ...
    public static void v(Type type) {
        dg.b(((type instanceof Class) && ((Class) type).isPrimitive()) ? false : true);
    }
}
