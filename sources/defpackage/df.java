...
public class df {
    public static Interpolator b(Context context, int id) throws Resources.NotFoundException {
        ...
        try {
            try {
                ...
                if (id == 17563661) {
                    ...
                    Interpolator a = a(context, context.getResources(), context.getTheme(), parser2);
                    if (parser2 != null) {
                        parser2.close();
                    }
                    return a;
    ...
    */
    public static android.view.animation.Interpolator a(android.content.Context r8, android.content.res.Resources r9, android.content.res.Resources.Theme r10, org.xmlpull.v1.XmlPullParser r11) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        /*
            r0 = 0
            int r1 = r11.getDepth()
        L5:
        ...
        Ld7:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.df.a(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser):android.view.animation.Interpolator");
    }
}
