...
public class ff implements TypeEvaluator {
    ...
    public Object evaluate(float fraction, Object startValue, Object endValue) {
        ...
        return Integer.valueOf((Math.round(a2 * 255.0f) << 24) | (Math.round(((float) Math.pow(r, 0.45454545454545453d)) * 255.0f) << 16) | (Math.round(((float) Math.pow(g, 0.45454545454545453d)) * 255.0f) << 8) | Math.round(((float) Math.pow(b, 0.45454545454545453d)) * 255.0f));
    }
}
