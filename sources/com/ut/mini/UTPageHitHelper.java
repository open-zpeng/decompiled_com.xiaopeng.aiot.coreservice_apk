...
public class UTPageHitHelper {
    ...
    private Queue<UTPageEventObject> f88a = new LinkedList();
    ...
    public static class UTPageEventObject {
        ...
        /* renamed from: a  reason: collision with other field name */
        private UTPageStatus f89a = null;
        ...
        public void resetPropertiesWithoutSkipFlagAndH5Flag() {
            ...
            this.aj = null;
            this.ak = null;
            UTPageStatus uTPageStatus = this.f89a;
    ...
    public synchronized void a(UTPageEventObject uTPageEventObject) {
        ...
        if (!this.f88a.contains(uTPageEventObject)) {
            this.f88a.add(uTPageEventObject);
        }
        if (this.f88a.size() > 200) {
            for (int i = 0; i < 100; i++) {
                UTPageEventObject poll = this.f88a.poll();
    ...
    /* renamed from: a  reason: collision with other method in class */
    public synchronized boolean m46a(Object obj) {
        if (obj != null) {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public synchronized void m45a(Object obj) {
        if (obj != null) {
            UTPageEventObject a2 = a(obj);
            if (a2.getPageStatus() != null) {
                a2.setH5Called();
    ...
    private synchronized UTPageEventObject a(Object obj) {
        String m43a = m43a(obj);
        if (this.A.containsKey(m43a)) {
            return this.A.get(m43a);
        }
        UTPageEventObject uTPageEventObject = new UTPageEventObject();
        this.A.put(m43a, uTPageEventObject);
        uTPageEventObject.setCacheKey(m43a);
    ...
    private synchronized void m44b(Object obj) {
        String m43a = m43a(obj);
        if (this.A.containsKey(m43a)) {
            this.A.remove(m43a);
        }
    ...
    public synchronized void a(Object obj, String str, boolean z) {
        if (obj != null) {
            String m43a = m43a(obj);
            if (m43a != null && m43a.equals(this.ah)) {
                return;
            }
            if (this.ah != null) {
                vj.a("lost 2001", "Last page requires leave(" + this.ah + ").");
            }
            UTPageEventObject a2 = a(obj);
            if (!z && a2.isSkipPage()) {
                vj.d("skip page[pageAppear]", "page name:" + obj.getClass().getSimpleName());
                return;
            }
            ...
            vj.a("pageAppear", "The page object should not be null");
        }
    }
    ...
    public synchronized void updatePageProperties(Object aPageObject, Map<String, String> aProperties) {
        ...
        vj.a("updatePageProperties", "failed to update project, parameters should not be null and the map should not be empty");
    }
    ...
    public synchronized void updatePageUrl(Object aPageObject, Uri aUrl) {
        ...
        Log.i(Progress.URL, Progress.URL + aUrl.toString());
    ...
    public synchronized void pageDisAppear(Object aPageObject) {
        if (aPageObject != null) {
            ...
            if (a2.isPageAppearCalled()) {
                ...
                if (pageUrl != null) {
                    ...
                    if (TextUtils.isEmpty(queryParameter)) {
                        try {
                            pageUrl = Uri.parse(URLDecoder.decode(pageUrl.toString(), XmartV1Constants.UTF8_ENCODING));
                ...
                if (defaultTracker != null) {
                    ...
                    vj.a("Record page event error", "Fatal Error,must call setRequestAuthentication method first.");
                }
            } else {
                vj.a("UT", "Please call pageAppear first(" + b(aPageObject) + ").");
            }
            this.z = new HashMap();
            if (a2.isSkipPage()) {
                a(a2);
            ...
            vj.a("pageDisAppear", "The page object should not be null");
        }
    }
