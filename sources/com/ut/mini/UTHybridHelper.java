...
public class UTHybridHelper {
    ...
    public void h5UT(Map<String, String> dataMap, Object view) {
        if (dataMap == null || dataMap.size() == 0) {
            vj.a("h5UT", "dataMap is empty");
            return;
        }
        String str = dataMap.get("functype");
        if (str == null) {
            vj.a("h5UT", "funcType is null");
            return;
        }
        String str2 = dataMap.get("utjstype");
        if (str2 != null && !str2.equals("0") && !str2.equals(DiskLruCache.VERSION_1)) {
            vj.a("h5UT", "utjstype should be 1 or 0 or null");
            return;
        }
    ...
    private void a(Date date, Map<String, String> map, Object obj) {
        ...
        if (b == null || TextUtils.isEmpty(b)) {
            vj.a("h5Page", "pageName is null,return");
            return;
        }
        ...
        int i = 2006;
        if (UTPageHitHelper.getInstance().m46a(obj)) {
            i = 2001;
        }
        ...
        if (defaultTracker != null) {
            ...
            vj.a("h5Page event error", "Fatal Error,must call setRequestAuthentication method first.");
        }
        UTPageHitHelper.getInstance().m45a(obj);
    }
    ...
    private void a(Date date, Map<String, String> map) {
        ...
        String b = b(map.get("urlpagename"), map.get(Progress.URL));
        if (b == null || TextUtils.isEmpty(b)) {
            vj.d("h5Ctrl", "pageName is null,return");
            return;
        }
        String str = map.get("logkey");
        if (str == null || TextUtils.isEmpty(str)) {
            vj.d("h5Ctrl", "logkey is null,return");
            return;
        }
        ...
        if (defaultTracker != null) {
            ...
            vj.a("h5Ctrl event error", "Fatal Error,must call setRequestAuthentication method first.");
        }
    }
    ...
    private Map<String, String> c(Map<String, String> map) {
        ...
        hashMap.put("_ish5", DiskLruCache.VERSION_1);
        return hashMap;
    }
