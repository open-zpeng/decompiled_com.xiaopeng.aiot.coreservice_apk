...
public class ApiRouter {
    ...
    private static RemoteOperator publishModule(UriStruct uriStruct, IBinder iBinder, String operationManifest) {
    ...
    public static <T> T route(Uri uri, byte[] blob) throws RemoteException {
        return (T) route(uri, true, blob);
    }

    private static <T> T route(Uri uri, boolean withBlob, byte[] blob) throws RemoteException {
