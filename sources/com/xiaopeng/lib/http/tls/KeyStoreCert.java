    ...
    public static SSLSocketFactory getTLS2SocketFactory() {
        ...
        try {
            ...
            if (!trustManager.isHasValidCert()) {
                ln.b().a(IpcConfig.AfterSalesConfig.IPC_REQUEST_REPAIRMODE_STATUS, "no valid ssl factory");
            }
            ...
            ln.b().a(IpcConfig.AfterSalesConfig.IPC_REQUEST_REPAIRMODE_STATUS, e.getLocalizedMessage());
            e.printStackTrace();
            return null;
        }
    }
    ...
    public static X509TrustManager getX509TrustManager() {
        try {
            ...
            if (!trustManager2.isHasValidCert()) {
                ln.b().a(IpcConfig.AfterSalesConfig.IPC_DIAG_REQUEST, "no valid trust manager");
            }
            return trustManager2;
        } catch (Exception e) {
            ln.b().a(IpcConfig.AfterSalesConfig.IPC_DIAG_REQUEST, e.getLocalizedMessage());
            e.printStackTrace();
            return null;
        }
    }
