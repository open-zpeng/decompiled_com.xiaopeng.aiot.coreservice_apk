...
public class HookTLSKitkatSocket {
    ...
    /* loaded from: classes.dex */
    public static class KitKatTLSInputStream extends CountingInputStream {
        private SSLSocket socket;

        public KitKatTLSInputStream(ICollector collector, SSLSocket sslSocket) throws IOException {
    ...
    /* loaded from: classes.dex */
    public static class KitKatTLSOutputStream extends CountingOutputStream {
        private SSLSocket socket;

        public KitKatTLSOutputStream(ICollector collector, SSLSocket sslSocket) throws IOException {
            super(collector, null);
            this.socket = sslSocket;
        }
