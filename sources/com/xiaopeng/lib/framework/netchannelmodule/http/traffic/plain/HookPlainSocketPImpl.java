...
public class HookPlainSocketPImpl extends SocketImpl {
    ...
    public int getPort() {
        return ((Integer) getValue(mFieldPort, this.mDelegate, Integer.valueOf(((SocketImpl) this).port))).intValue();
    }

    @Override // java.net.SocketImpl
    public InetAddress getInetAddress() {
        return (InetAddress) getValue(mFieldAddress, this.mDelegate, ((SocketImpl) this).address);
    }

    @Override // java.net.SocketImpl
    public int getLocalPort() {
        return ((Integer) getValue(mFieldLocalPort, this.mDelegate, Integer.valueOf(((SocketImpl) this).localport))).intValue();
    }

    @Override // java.net.SocketImpl
    public FileDescriptor getFileDescriptor() {
        return (FileDescriptor) getValue(mFieldFd, this.mDelegate, ((SocketImpl) this).fd);
    }

    private void syncFd() {
        ((SocketImpl) this).fd = (FileDescriptor) getValue(mFieldFd, this.mDelegate, ((SocketImpl) this).fd);
    }

    public void syncFromLocalToDelegate() {
        setValue(mFieldFd, this.mDelegate, ((SocketImpl) this).fd);
        setValue(mFieldAddress, this.mDelegate, ((SocketImpl) this).address);
        setValue(mFieldPort, this.mDelegate, Integer.valueOf(((SocketImpl) this).port));
        setValue(mFieldLocalPort, this.mDelegate, Integer.valueOf(((SocketImpl) this).localport));
    }
    ...
    public void connect(InetAddress address, int port) throws IOException {
        pn.a(TAG, "InetAddr=" + address + ", port=" + port);
        StringBuilder sb = new StringBuilder();
    ...
    public void connect(SocketAddress remoteAddr, int timeout) throws IOException {
        pn.a(TAG, "SocketAddr=" + remoteAddr);
