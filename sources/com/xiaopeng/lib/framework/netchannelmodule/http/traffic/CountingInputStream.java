...
public class CountingInputStream extends FilterInputStream {
    ...
    public CountingInputStream(ICollector collector, InputStream in) throws IOException {
        super(in);
        this.mCollector = collector;
    }

    public CountingInputStream setStatisticCounter(BaseHttpCounter counter) {
    ...
    public int read() throws IOException {
        ...
        int result = ((FilterInputStream) this).in.read();
    ...
    public int read(byte[] b, int off, int len) throws IOException {
        BaseHttpCounter baseHttpCounter;
        int length = ((FilterInputStream) this).in.read(b, off, len);
