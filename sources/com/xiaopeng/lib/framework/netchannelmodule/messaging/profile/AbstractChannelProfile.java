...
public abstract class AbstractChannelProfile {
    ...
    static {
        ...
        SYSTEM_PROPERTY_MQTT_USER = "persist.sys.mqtt.user" + co.a();
        SYSTEM_PROPERTY_MQTT_PASS = "persist.sys.mqtt.pass" + co.a();
        SYSTEM_PROPERTY_MQTT_ID = "persist.sys.mqtt.id" + co.a();
        SYSTEM_PROPERTY_MQTT_REPORTING_URL = "persist.sys.mqtt.url" + co.a();
        SYSTEM_PROPERTY_MQTT_COMM_URL = "persist.sys.mqtt.comm_url" + co.a();
        SYSTEM_PROPERTY_MQTT_COMM_ID = "persist.sys.mqtt.comm_id" + co.a();
        SYSTEM_PROPERTY_MQTT_COMM_USER = "persist.sys.mqtt.comm_user" + co.a();
        SYSTEM_PROPERTY_MQTT_COMM_PASS = "persist.sys.mqtt.comm_pass" + co.a();
    }
    ...
    public String decode(String str) {
        ...
        if (sShorterAccountEncoding) {
            result = ao.b(str, AES_KEY);
        } else {
            result = ao.a(str, AES_KEY);
        }
    ...
    */
    ...
    public fw mqttClientPersistence() {
