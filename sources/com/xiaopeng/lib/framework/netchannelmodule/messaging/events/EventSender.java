...
public class EventSender {
    ...
    public void postDeliveryCompleted(long messageId, byte[] message) {
    ...
    public void postDisconnected(Throwable cause) {
        int reasonCode = 0;
        int protocolReasonCode = 0;
        String errMsg = null;
        if (cause != null) {
            errMsg = cause.getMessage();
            if (cause instanceof iw) {
                reasonCode = 1;
                protocolReasonCode = ((iw) cause).a();
