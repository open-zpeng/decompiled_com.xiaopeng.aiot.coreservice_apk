...
public class ReceivedMessageEvent implements IEvent {
    ...
    public ReceivedMessageEvent(IEvent.TYPE eventType) {
        this.mType = eventType;
    }

    public ReceivedMessageEvent topic(String topic) {
        this.mTopic = topic;
        return this;
    }

    public ReceivedMessageEvent message(String body) {
        if (body == null) {
            throw new AssertionError();
        }
        this.mMessageBody = body.getBytes();
        return this;
    }

    public ReceivedMessageEvent message(byte[] body) {
        if (body == null) {
            throw new AssertionError();
        }
