...
public class SystemStatusMonitor {
    public static final String TAG = "SystemStatusMonitor";
    ...
    public class BroadcastReceiver extends android.content.BroadcastReceiver {
        ...
        private void onNetworkChanged() {
            wn.i(new Runnable() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.SystemStatusMonitor.BroadcastReceiver.1
