...
public class LoggerImpl implements qy {
    ...
    private void logInternal(Level julLevel, String sourceClass, String sourceMethod, String msg, Object[] inserts, Throwable thrown) {
        ...
        if (thrown != null) {
            pn.g(this.mLogTag, message, thrown);
        } else {
            pn.a(this.mLogTag, message);
        }
    }
    ...
    private void checkException(Object[] inserts) {
        ...
        for (Object ex : inserts) {
            if (ex != null && (ex instanceof iw)) {
                int reasonCode = ((iw) ex).a();
                Throwable throwable = ((iw) ex).getCause();
                if (reasonCode == 32101 || reasonCode == 32102 || reasonCode == 32109) {
                    MqttChannel.getInstance().disconnectedDueToException((iw) ex);
                    return;
