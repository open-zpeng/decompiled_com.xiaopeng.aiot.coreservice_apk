...
public class MqttChannel {
            ...
            public void run() {
                try {
                    if (MqttChannel.this.networkAvailable()) {
                        ...
                        pn.a("NetChannel-MqttChannel", "Network is not available, delay to try...");
                    }
                } catch (Exception e) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void reInitMqtt(AbstractChannelProfile profile) throws MessagingException {
        if (profile == null) {
    ...
    public void disconnectConnection() {
        ...
        try {
            fw fwVar = this.mMemoryPersistence;
            if (fwVar != null) {
                fwVar.close();
            }
        } catch (Exception e2) {
    ...
    public boolean connectMqtt() throws MessagingException {
        if (this.mMqttAndroidClient == null || this.mMqttConnectOptions == null) {
            ...
            try {
                ...
                this.mMqttAndroidClient.j(this.mMqttConnectOptions, this.mApplicationContext, new xv() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.5
                    ...
                    public void onFailure(bw asyncActionToken, Throwable exception) {
                        ...
                        MqttChannel.this.mScheduler.moveTo(Scheduler.STATE.DISCONNECTED);
                        pn.a("NetChannel-MqttChannel", "connectMqtt failed! release connection resources in time");
                        try {
    ...
    private boolean initAndroidClientSuccess() throws MessagingException {
        pn.l("NetChannel-MqttChannel", "initAndroidClientSuccess mMqttAndroidClient = " + this.mMqttAndroidClient);
        ...
        fw fwVar = this.mMemoryPersistence;
        if (fwVar instanceof MemoryPersistenceProxy) {
            ((MemoryPersistenceProxy) fwVar).setTraceEnabled(this.mChannelProfile.enableTrace());
        }
        ...
        this.mMqttAndroidClient.A(new sv() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.6
    ...
    public void subscribeInternal(final String topic) {
        ...
        try {
            this.mMqttAndroidClient.E(topic, this.mChannelProfile.defaultQoSLevel(), null, new xv() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.8
                @Override // defpackage.xv
                public void onSuccess(bw asyncActionToken) {
                    MqttChannel mqttChannel = MqttChannel.this;
    ...
    public long publishMessage(String topic, byte[] msg, int qosLevel) throws MessagingException {
        ...
        jw mqttMessage = new jw();
        mqttMessage.h(msg);
        mqttMessage.i(qosLevel);
        synchronized (this) {
            try {
                Counter counter = this.mCounter;
                if (counter != null) {
                ...
                bw token = this.mMqttAndroidClient.u(topic, mqttMessage, null, new xv() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.9
                    @Override // defpackage.xv
                    public void onSuccess(bw asyncActionToken) {
                    }
                    ...
                    public void onFailure(bw asyncActionToken, Throwable exception) {
                        ...
                        if (exception instanceof iw) {
                            MqttChannel.this.mEventSender.postDeliveryFailure(asyncActionToken.a(), ((iw) exception).a());
                            logMessage = "Failed to publish, exception (A):" + ((iw) exception);
                            MqttChannel.this.logInternal(logMessage);
                        } else {
                            logMessage = "Failed to publish, exception (B):" + exception;
                            MqttChannel.this.logInternal(logMessage);
                            MqttChannel.this.mEventSender.postDeliveryFailure(asyncActionToken.a(), 0);
                        }
                ...
                if (e instanceof iw) {
                    this.mEventSender.postDeliveryFailure(0L, ((iw) e).a());
                } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean realNetworkException(Throwable throwable) {
        if (throwable == null) {
            return false;
        }
    ...
    public void log(String message) {
        pn.l("NetChannel-MqttChannel", message);
    }
    ...
    /* loaded from: classes.dex */
    public class MqttCallbackImpl implements ew {
        ...
        @Override // defpackage.dw
        public void messageArrived(String topic, jw message) {
            pn.a("NetChannel-MqttChannel", "messageArrived: topic = " + topic);
            MqttChannel.this.mEventSender.postReceivedMessage(topic, message.b());
            MqttChannel.this.mScheduler.resetFail();
            if (MqttChannel.this.mCounter != null) {
        ...
        public void deliveryComplete(zv token) {
            if (co.j()) {
                MqttChannel.this.mEventSender.postDeliveryCompleted(token.a());
            } else {
                try {
                    MqttChannel.this.mEventSender.postDeliveryCompleted(token.a(), token.getMessage().b());
                } catch (Exception ex) {
                    pn.a("NetChannel-MqttChannel", "Delivered completely, but met exception while getting message:" + ex);
                }
            }
            MqttChannel.this.mScheduler.resetFail();
            long payloadSize = 0;
            try {
                if (token.getMessage() != null && token.getMessage().b() != null) {
                    payloadSize = token.getMessage().b().length;
                }
            } catch (Exception e) {
            }
            if (MqttChannel.this.mCounter != null) {
    ...
    public class ExtremePingSender {
        ...
        private xv mPingActionListener;
        ...
        private ExtremePingSender() {
            ...
            this.mPingActionListener = new xv() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.ExtremePingSender.1
                @Override // defpackage.xv
                public void onSuccess(bw asyncActionToken) {
        ...
        public static /* synthetic */ int access$1808(ExtremePingSender x0) {
            int i = x0.mSucceedCount;
            x0.mSucceedCount = i + 1;
            return i;
        }

        public void startExtremePingSender(Runnable exceptionHandlingRunnable) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public boolean sendExtremePing(xv listener) throws MessagingException {
            ...
            synchronized (this) {
                try {
                    MqttChannel.this.mMqttAndroidClient.i(listener);
                    published = true;
                } catch (Exception e) {
            ...
            this.mUnexpectedHandlingAction = new Runnable() { // from class: com.xiaopeng.lib.framework.netchannelmodule.messaging.protocol.MqttChannel.SchedulerClient.3
                ...
                public void run() {
                    if (MqttChannel.this.mMqttAndroidClient != null) {
                        ...
                        pn.a("NetChannel-MqttChannel", "mUnexpectedHandlingAction: connected state = " + MqttChannel.this.mScheduler.connected() + ", " + MqttChannel.this.mMqttAndroidClient.r());
    ...
    public boolean networkAvailable() {
        if (rn.d(this.mApplicationContext)) {
            return !rn.c(this.mApplicationContext) || rn.e();
        }
        return false;
    }
}
