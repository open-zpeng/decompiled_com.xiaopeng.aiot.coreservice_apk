...
public final class GlobalConfig {
    ...
    static {
        File file = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + DEBUG_FLAG_FILE);
        sDebuggable = file.exists();
    }
    ...
    public static SSLSocketFactory getSocketFactory() {
        ...
        return HttpsUtils.getTLS2SocketFactory(application);
    }
