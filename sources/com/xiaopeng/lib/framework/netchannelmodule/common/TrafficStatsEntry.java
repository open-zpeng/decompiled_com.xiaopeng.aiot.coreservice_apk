...
public class TrafficStatsEntry {
    ...
    static {
        ...
        hashMap.put(IpcConfig.App.CAR_ACCOUNT, new Entry(100014, TAG_APP_CAR_ACCOUNT));
        hashMap.put(IpcConfig.App.CAR_CONTROL, new Entry(100015, TAG_APP_CAR_CONTROL));
        hashMap.put(IpcConfig.App.CAR_SETTINGS, new Entry(100016, TAG_APP_CAR_SETTINGS));
