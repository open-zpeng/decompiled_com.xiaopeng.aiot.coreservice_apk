...
public class IrdetoSecurity implements ISecurityModule {
    ...
    private void initInternal(Context context, boolean forIndividual) {
        ...
        try {
            ...
            sIsInitSuccess = true;
            pn.a(TAG, "irdeto sdk init success");
            ...
            switch (e.getErrorCode()) {
                case 10:
                    if (co.g()) {
                        sIsInitSuccess = true;
                        pn.a(TAG, "irdeto sdk init success for eng root");
                        break;
                    }
                    break;
                case 14:
                    pn.f(TAG, "irdeto sdk init failed : secure store error!!!!");
                    clearFlag();
                    break;
            }
    ...
    private void checkSaveIndividualFlag() {
        if (!SecurityCommon.getBuildInfoFlag().equals(getIndividualFlag())) {
            pn.f(TAG, "irdeto delete indiv files");
            clearFlag();
        }
    }
    ...
    public void asyncGetMCUSecurityKey(final ICallback<byte[], String> callback) {
        pn.r(TAG, "asyncGetMCUSecurityKey");
        new Thread(new Runnable() { // from class: com.xiaopeng.lib.security.irdeto.IrdetoSecurity.1
            ...
            public void run() {
                try {
                    ...
                    e.printStackTrace();
                    pn.r(IrdetoSecurity.TAG, "null mcu security key");
                    callback.onError("null mcu security key");
                }
            }
        }).start();
    ...
    public String encode(String str) {
        synchronized (IrdetoSecurity.class) {
            ...
            try {
                ...
                pn.a(TAG, "irdeto encode result " + result);
                return result;
            } catch (Exception e) {
                pn.i(TAG, e);
                return "";
    ...
    public String decode(String str) {
        synchronized (IrdetoSecurity.class) {
            ...
            try {
                ...
                pn.a(TAG, "irdeto decode result " + result);
                return result;
            } catch (Exception e) {
                pn.i(TAG, e);
                return "";
    ...
    public boolean isInitAndIndivSuccess() {
        synchronized (IrdetoSecurity.class) {
            if (!sIsInitSuccess) {
                pn.a(TAG, "Irdeto sdk not init " + this.sInitErrorMsg);
                return false;
            }
            try {
    ...
    public synchronized void asyncSaveToken(final String[] ids, final String[] token, final Runnable runnable) {
        wn.i(new Runnable() { // from class: com.xiaopeng.lib.security.irdeto.IrdetoSecurity.2
            @Override // java.lang.Runnable
            public void run() {
                try {
    ...
    public synchronized void asyncSaveTokenWithListener(final String[] ids, final String[] token, final ISecurityModule.ResultListener listener) {
        wn.i(new Runnable() { // from class: com.xiaopeng.lib.security.irdeto.IrdetoSecurity.3
            @Override // java.lang.Runnable
            public void run() {
    ...
    private static void registerISFSecureStoreReloadReceiver() {
        pn.a(TAG, "registerISFSecureStoreReloadReceiver");
        try {
            ...
            sContext.registerReceiver(new BroadcastReceiver() { // from class: com.xiaopeng.lib.security.irdeto.IrdetoSecurity.4
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    if (IrdetoSecurity.ACTION_BROADCAST_ISF_SECURE_STORE_RELOAD.equals(action)) {
                        try {
                            pn.a(IrdetoSecurity.TAG, "registerISFSecureStoreReloadReceiver ACTION_BROADCAST_ISF_SECURE_STORE_RELOAD");
    ...
    private void printErrorReason(String head) {
        pn.a(TAG, head + this.sInitErrorMsg);
    }
}
