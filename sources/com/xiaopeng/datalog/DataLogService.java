...
public class DataLogService implements IDataLog {
    ...
    /* loaded from: classes.dex */
    public class StatEventBuilder implements IStatEventBuilder {
        private IStatEvent event;

        public StatEventBuilder(Context context) {
    ...
    /* loaded from: classes.dex */
    public class MoleEventBuilder implements IMoleEventBuilder {
        public MoleEvent event;
