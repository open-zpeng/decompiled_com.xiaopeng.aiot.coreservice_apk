...
public class StatMqttDelegate extends AbstractStatDelegate implements Handler.Callback {
    ...
    public void uploadCdu(final IStatEvent event) {
        wn.h(0, new Runnable() { // from class: com.xiaopeng.datalog.stat.StatMqttDelegate.1
            @Override // java.lang.Runnable
            public void run() {
                pn.a(StatMqttDelegate.TAG, "uploadCdu stat:" + event.toString());
    ...
    public void uploadCdu(final IMoleEvent event) {
        wn.h(0, new Runnable() { // from class: com.xiaopeng.datalog.stat.StatMqttDelegate.2
            @Override // java.lang.Runnable
            public void run() {
                pn.a(StatMqttDelegate.TAG, "uploadCdu mole:" + event.toString());
                StatMqttDelegate.this.uploadCdu(event.toJson());
            }
        });
    }
    ...
    /* loaded from: classes.dex */
    public class StatEventWithFiles {
