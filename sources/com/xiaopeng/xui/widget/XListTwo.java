...
public class XListTwo extends XRelativeLayout {
    ...
    public final void d() {
        ...
        if (this.i != null) {
            if (this.k == 1) {
                for (Class<?> cls : sq.a) {
                    List<View> views = tq.c(this.i, cls);
                    if (views.size() > 0) {
    ...
    public final void f() {
        if (this.j != null) {
            ...
            if (this.k == 2) {
                ...
                while (i < length) {
                    Class<?> cls = clsArr[i];
                    List<View> views = tq.c(this.j, cls);
                    if (views.size() > 0) {
                        View[] views1 = new View[views.size()];
                        views.toArray(views1);
                        sq.c(views1, this);
                ...
                while (i < length2) {
                    ...
                    List<View> views2 = tq.c(this.j, cls2);
                    if (views2.size() > 0) {
    ...
    public void setTextSub(CharSequence text) {
        this.d.setText(text);
    }

    public void setTagIcon(int res) {
        if (!nq.a()) {
            ((ImageView) this.g).setImageResource(res);
        }
    }

    public XTextView getTagView() {
        if (nq.a()) {
            return (XTextView) this.g;
        }
        return null;
    }
    ...
    public void i(boolean enabled, boolean containChild) {
    ...
    public final void h(ViewGroup viewGroup, boolean enabled) {
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            View view = viewGroup.getChildAt(i);
            if (view instanceof ViewGroup) {
                h((ViewGroup) view, enabled);
            }
            if (nq.a()) {
