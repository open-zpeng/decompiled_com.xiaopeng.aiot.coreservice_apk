...
public class XImageButton extends AppCompatImageButton implements dr {
    public uq d;
    public Rect f;
    ...
    public final void d(AttributeSet attrs) {
        ...
        if (uqVar != null && uqVar.e() != null) {
            this.d.e().m(new fo.a() { // from class: lr
    ...
    public /* synthetic */ void h() {
        post(new Runnable() { // from class: kr
    ...
    public /* synthetic */ void j() {
        if (this.f != null) {
            a("XImageButton change theme reset backgroundPadding");
            Rect rect = this.f;
