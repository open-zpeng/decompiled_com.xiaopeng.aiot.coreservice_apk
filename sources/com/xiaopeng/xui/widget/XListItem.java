...
public class XListItem extends XConstraintLayout {
    public TextView B;
    public TextView C;
    public TextView D;
    public XTextView E;
    ...
    @Override // com.xiaopeng.xui.widget.XConstraintLayout, defpackage.dr
    ...
    public void setTextSub(String text) {
    ...
    public void setTagVisible(boolean isVisible) {
        this.E.setVisibility(isVisible ? 0 : 8);
    }
    ...
    public final void J() {
        ...
        if (viewGroup != null) {
            if (this.I == 1) {
                for (Class<?> cls : sq.a) {
                    List<View> views = tq.c(this.F, cls);
                    if (views.size() > 0) {
    ...
    public final void K() {
        if (this.G != null) {
            ...
            if (this.I == 2) {
                ...
                while (i < length) {
                    Class<?> cls = clsArr[i];
                    List<View> views = tq.c(this.G, cls);
                    if (views.size() > 0) {
                        View[] views1 = new View[views.size()];
                        views.toArray(views1);
                        sq.c(views1, this);
            ...
            while (i < length2) {
                ...
                List<View> views2 = tq.c(this.G, cls2);
                if (views2.size() > 0) {
    ...
    public void M(boolean enabled, boolean containChild) {
    ...
    public final void L(ViewGroup viewGroup, boolean enabled) {
        for (int i = 0; i < viewGroup.getChildCount(); i++) {
            View view = viewGroup.getChildAt(i);
            if (view instanceof ViewGroup) {
                L((ViewGroup) view, enabled);
            }
            if (nq.a()) {
