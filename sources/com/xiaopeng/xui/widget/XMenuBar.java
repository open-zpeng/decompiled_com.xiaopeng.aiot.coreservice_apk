    ...
    public void setPosition(int position) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            if (position == i) {
                ...
                getChildAt(i).findViewById(xo.x_text_menu_item).setSelected(true);
            } else {
                getChildAt(i).setSelected(false);
                getChildAt(i).findViewById(xo.x_text_menu_item).setSelected(false);
            }
        }
        a aVar = this.b;
        if (aVar != null && v != null) {
            aVar.a(v, position, false);
        }
    }
