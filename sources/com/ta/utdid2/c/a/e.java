...
public class e {
    ...
    public static final HashMap m41a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static final int[] m42a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
    ...
    private static final Object b(XmlPullParser xmlPullParser, String[] strArr) throws XmlPullParserException, IOException {
        ...
        if (!name.equals("null")) {
            if (name.equals("string")) {
                ...
                xmlPullParser.next();
                int[] m42a = m42a(xmlPullParser, "int-array", strArr);
                strArr[0] = attributeValue;
                return m42a;
            } else if (name.equals("map")) {
                xmlPullParser.next();
                HashMap m41a = m41a(xmlPullParser, "map", strArr);
                strArr[0] = attributeValue;
                return m41a;
