...
public class a implements XmlSerializer {
    ...
    private OutputStream f72a;

    /* renamed from: a  reason: collision with other field name */
    private Writer f73a;

    /* renamed from: a  reason: collision with other field name */
    private CharsetEncoder f75a;
    private boolean f;
    private int mPos;

    /* renamed from: a  reason: collision with other field name */
    private final char[] f76a = new char[8192];

    /* renamed from: a  reason: collision with other field name */
    private ByteBuffer f74a = ByteBuffer.allocate(8192);
    ...
    private void a(String str, int i, int i2) throws IOException {
        ...
        str.getChars(i, i + i2, this.f76a, i5);
        this.mPos = i5 + i2;
    }
    ...
    private void append(char[] buf, int i, int length) throws IOException {
        ...
        System.arraycopy(buf, i, this.f76a, i4, length);
        this.mPos = i4 + length;
    }
    ...
    private void b() throws IOException {
        int position = this.f74a.position();
        if (position > 0) {
            this.f74a.flip();
            this.f72a.write(this.f74a.array(), 0, position);
            this.f74a.clear();
        }
    }
    ...
    public void flush() throws IOException {
        ...
        if (i > 0) {
            if (this.f72a != null) {
                CharBuffer wrap = CharBuffer.wrap(this.f76a, 0, i);
                CoderResult encode = this.f75a.encode(wrap, this.f74a, true);
                while (!encode.isError()) {
                    if (encode.isOverflow()) {
                        b();
                        encode = this.f75a.encode(wrap, this.f74a, true);
                    } else {
                        b();
                        this.f72a.flush();
                    }
    ...
    public void setOutput(OutputStream os, String encoding) throws IOException, IllegalArgumentException, IllegalStateException {
        ...
        try {
            this.f75a = Charset.forName(encoding).newEncoder();
            this.f72a = os;
