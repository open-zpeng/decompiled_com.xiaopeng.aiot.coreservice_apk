...
public class c {
    ...
    private com.ta.utdid2.c.a.c f84a;
    ...
    /* renamed from: a  reason: collision with other field name */
    private Pattern f86a = Pattern.compile("[^0-9a-zA-Z=/+]+");
    ...
    public c(Context context) {
        ...
        this.f84a = new com.ta.utdid2.c.a.c(context, ".DataStorage", "ContextData", false, true);
        this.f85a = new d();
    ...
    private void d() {
        ...
        if (cVar != null) {
            ...
            boolean z = false;
            boolean z2 = true;
            if (!i.m35a(this.b.getString("DID"))) {
                this.b.remove("DID");
                z = true;
            }
            if (!i.m35a(this.b.getString("EI"))) {
                this.b.remove("EI");
                z = true;
            }
            if (i.m35a(this.b.getString("SI"))) {
                z2 = z;
            } else {
                this.b.remove("SI");
            }
    ...
    private void g(String str) {
        com.ta.utdid2.c.a.c cVar;
        if (str != null && (cVar = this.f84a) != null && !str.equals(cVar.getString(this.m))) {
            this.f84a.putString(this.m, str);
            this.f84a.commit();
        }
    }
    ...
    private String g() {
        ...
        if (cVar != null) {
            ...
            if (!i.m35a(string) && this.f85a.a(string) != null) {
                return string;
            }
            return null;
        }
    ...
    private boolean b(String str) {
        if (str != null) {
            ...
            if (24 == str.length() && !this.f86a.matcher(str).find()) {
                return true;
            }
        }
        return false;
    ...
    public synchronized String h() {
        ...
        String string2 = this.f84a.getString(this.m);
        if (!i.m35a(string2)) {
            String b3 = eVar.b(string2);
            if (!b(b3)) {
                b3 = this.f85a.b(string2);
            }
            if (b(b3)) {
                String a4 = this.f85a.a(b3);
                if (!i.m35a(b3)) {
                    this.l = b3;
                    if (z) {
                        j(a4);
